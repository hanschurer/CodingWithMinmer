...
void merge_3_sorted_lists_first_variant_21() {
    std::vector<int> a = {1, 1, 1, 3, 4, 5};
    std::vector<int> b = {3, 3, 4, 5, 6};
    std::vector<int> c = {1, 1, 3, 3, 8, 8, 8, 10};
    std::vector<int> expected = {1, 1, 1, 1, 1, 3, 3, 3, 3, 3, 4, 4, 5, 5, 6, 8, 8, 8, 10};
    assert(expected == merge_3_sorted_lists_first_variant_21(a, b, c));
